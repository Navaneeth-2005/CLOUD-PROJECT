...
const sendContestCredentials = async (
      ...
      <div class="container">
        ...
        <div class="header">
          ...
          <div class="header-sub">
            Cloud-Based Coding Assessment Platform
          </div>
        </div>
        ...
        <div class="body">
          ...
          <div class="message">
            ...
            Please keep this email safe and do not share your credentials with anyone.
          </div>
          ...
          <div class="contest-box">
            ...
            <div class="contest-detail">
              ...
              <span class="contest-detail-value">
            ...
            <div class="contest-detail">
              ...
              <span class="contest-detail-value">
                ${contestDetails.questionCount} questions
              </span>
            </div>
  ...
  const command = new SendEmailCommand({
    ...
    Message: {
      ...
      Subject: {
        Charset: 'UTF-8',
        Data: `🎯 You're registered for ${contestTitle} — CodeStorm`,
      },
    },

    Source: `"CodeStorm" <${fromEmail}>`,
  });
