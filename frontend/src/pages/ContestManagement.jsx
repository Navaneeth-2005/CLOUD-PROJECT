                    ...
                    {analytics.byQuestion?.map((q, i) => (
                      <div key={i} style={styles.questionItem}>
                        ...
                        <div style={styles.questionStats}>
                          ...
                          <span style={{ ...styles.questionAccepted, color: '#10b981' }}>
          ...
          <div style={styles.modal} onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleAddQuestion} style={styles.modalForm}>
              ...
              <div style={styles.modalActions}>
                <button type="button" style={styles.cancelBtn} onClick={() => setShowQuestionModal(false)}>
                  Cancel
                </button>
            ...
            <form onSubmit={handleAddTestCase} style={styles.modalForm}>
              <div style={styles.field}>
                ...
                <textarea
                  ...
                  placeholder="Enter the test case input exactly as your program should receive it from stdin"
                  required
                />
              </div>
              ...
              <div style={styles.field}>
                ...
                <textarea
                  ...
                  placeholder="Enter the exact expected output your program should print to stdout"
                  required
                />
              </div>
              ...
              <div style={styles.formRow}>
                <div style={styles.field}>
                  <label style={styles.label}>Marks for this test case</label>
                  <input
                    type="number"
                ...
                <div style={styles.field}>
                  ...
                  <select
                    ...
                    style={styles.input}
                  >
                    <option value="false">Visible — shown as sample to candidates</option>
                    <option value="true">Hidden — only used for evaluation</option>
                  </select>
                </div>
              </div>
              ...
              <div style={{
                ...
                ⚠️ Make sure input and output match exactly what your program reads from stdin and writes to stdout.
                Extra spaces or newlines will cause test cases to fail.
              </div>

              <div style={styles.modalActions}>
                <button type="button" style={styles.cancelBtn} onClick={() => setShowTestCaseModal(false)}>
                  Cancel
                </button>
                <button type="submit" style={styles.submitBtn}>
                  Add Test Case
